      ...
      <Card elevation={2}>
        <CardContent>
          ...
          {loading ? (
              ...
              <Box sx={{ p: 3, textAlign: 'center' }}>
                <Typography color="textSecondary">{t('noSensors')}</Typography>
              </Box>
          ) : (
              <TableContainer>
                <Table>
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell>{t('metricKey')}</TableCell>
                      <TableCell>{t('alertCondition')}</TableCell>
                      <TableCell>{t('alertLevel')}</TableCell>
