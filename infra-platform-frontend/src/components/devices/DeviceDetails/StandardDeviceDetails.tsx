...
function CircularProgressWithLabel({ value, size = 100, thickness = 5, ...props }) {
...
const StandardDeviceDetails = ({ device }) => {
            ...
            <Paper sx={{ p: 3, borderRadius: 2, height: '100%' }}>
              ...
              <Box sx={{ mb: 4 }}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1 }}>
                  ...
                  <Typography variant="body1" fontWeight={700} sx={{ color: getColorByUsage(memory.percent) }}>
              ...
              {memory.swap_total > 0 && (
                <Box sx={{ mt: 4 }}>
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1 }}>
                    ...
                    <Typography variant="body2" fontWeight={600} sx={{ color: getColorByUsage(memory.swap_percent) }}>
                  ...
                  <Paper
                    ...
                    sx={{
                      ...
                      '&::before': {
                        ...
                        bottom: 0,
                        width: 4,
                        backgroundColor: container.status === 'running' ? theme.palette.success.main : theme.palette.warning.main,
                      }
                    }}
                  >
                    ...
                    <Grid container spacing={2}>
                      <Grid item xs={6} sm={3}>
                        ...
                        <Typography variant="body2" fontWeight={600} color={getColorByUsage(container.cpu_percent)}>
