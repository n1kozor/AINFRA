                    ...
                    <Grid container spacing={2}>
                      ...
                      <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                        ...
                        >
                          ...
                          <Typography variant="body2" color="text.secondary">
                            {t('dashboard.deviceStatus.available')}: {statistics.availability_summary.devices_available} • {t('dashboard.deviceStatus.unavailable')}: {statistics.availability_summary.devices_unavailable}
                          </Typography>
                        </Paper>
                      </Grid>
                      ...
                      <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                        ...
                        >
                          ...
                          <Typography variant="body2" color="text.secondary">
                            {t(statistics.system_status.check_interval_minutes > 1 ? 'dashboard.timeRange.minutes' : 'dashboard.timeRange.minute')}
                          </Typography>
                        </Paper>
                      </Grid>
                    </Grid>
