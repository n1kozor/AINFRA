      ...
      >
        <Toolbar>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Tooltip
                title={t('header.tooltips.changeTheme')}
                arrow
            >
              <IconButton
                  color="inherit"
            ...
            <Tooltip
                title={t('header.tooltips.changeLanguage')}
                arrow
            >
              <IconButton
                  color="inherit"
          ...
          >
            ...
            >
              ...
              <ListItemText primary={t('language.hungarian')} />
            </MenuItem>
          </Menu>
                          ...
                          <ListItem alignItems="flex-start">
                            ...
                            <Box sx={{ flexGrow: 1, minWidth: 0 }}>
                              ...
                              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                <Chip
                                    label={`${t('alerts.value')}: ${alert.value}`}
                                    size="small"
                                    sx={{
                                      bgcolor: alpha(getAlertColor(alertLevel), 0.1),
                                      color: getAlertColor(alertLevel),
