        ...
        <Card elevation={2}>
            <CardContent>
                <Stack direction="row" alignItems="center" spacing={2} mb={2}>
                    ...
                    <Typography variant="h6">{t('sensors.deviceFilter')}</Typography>
                </Stack>
                <FormControl fullWidth>
                    <InputLabel id="device-filter-label">{t('sensors.device')}</InputLabel>
                    <Select
                        ...
                        sx={{ minWidth: 200 }}
                    >
                        <MenuItem value="">{t('sensors.allDevices')}</MenuItem>
                        {devices.map((device) => (
