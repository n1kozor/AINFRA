...
const PluginDetails = () => {
    ...
    // SafeCheck for verified property
    const isVerified = 'verified' in plugin ? Boolean(plugin.verified) : false;
    ...
    return (
        <PageContainer
            ...
            breadcrumbs={[
                { text: t('navigation.dashboard'), link: '/' },
                { text: t('navigation.plugins'), link: '/plugins' },
                { text: plugin.name },
            ]}
            actions={
